...
/**
 * @summary Pauses the stream
 */
MumbleInputStream.prototype.pause = function() {
    if( this.processInterval ) clearInterval( this.processInterval );
    this.processInterval = null;
    this.paused = true
};
...
/**
 * @summary Resumes the stream
 */
MumbleInputStream.prototype.resume = function() {
    if( this.processInterval ) clearInterval( this.processInterval );
    this.processInterval = setInterval(
        this._processBuffer.bind( this ),
        this.connection.FRAME_LENGTH );
...
/**
 * @summary Clear the buffer and continue playing the stream
 */
MumbleInputStream.prototype.clearBuffer = function() {
    if( this.processInterval ) clearInterval( this.processInterval );
    this.processInterval = setInterval(
        this._processBuffer.bind( this ),
        this.connection.FRAME_LENGTH );
